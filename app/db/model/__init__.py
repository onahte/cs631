...
class Own(db.Model):
    ...
    def __init__(self, cid, corporate_id, eid, percent_own):
        self.cid = cid
        self.corporate_id = corporate_id
        self.eid = eid
...
class Patient(db.Model):
    ...
    def __repr__(self):
        return f'Patient({self.pid}, {self.ssn}, {self.name}, {self.street}, {self.city}, {self.state}, ' \
               f'{self.zip}, {self.dob}, {self.gender}, {self.number}, {self.eid}) '
